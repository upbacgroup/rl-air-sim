...
from airsimdroneracinglab.utils import *
from airsimdroneracinglab.types import *
from airsimdroneracinglab.baseline import *
...
class VehicleClient:
    ...
    def simGetObjectPose(self, object_name):
        ...
        elif self.race_tier == 1 or self.race_tier == 4:
            pose = self.client.call("simGetObjectPose", object_name, False)
